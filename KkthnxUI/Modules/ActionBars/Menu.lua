...
local menuList = {
    ...
    },
    {
        ...
        -- icon = 'Interface\\AddOns\\KkthnxUI\\Media\\Textures\\picomenuTalents',
        func = function()
    ...
    },
    {
        ...
        icon = 'Interface\\AddOns\\KkthnxUI\\Media\\Textures\\picomenuAchievement',
        func = function()
    ...
    },
    {
        ...
        func = function()
            securecall(ToggleLFDQueueFrame, 1)
        end,
...
local function UpdateAddOnTable()
    if (IsAddOnLoaded('KkthnxUI_Config') and not v1) then
        x = true
        n = (#addonMenuTable[2].menuList)+1
        v1 = true
        addonMenuTable[2].menuList[n] = {
            text = '|cFF4488FFKkthnx|r|cFFFEB200UI|r',
            func = function()
                CreateUIConfig()
            end,
            notCheckable = true,
...
f:SetNormalTexture('Interface\\AddOns\\KkthnxUI\\Media\\Textures\\picomenuNormal') 
f:GetNormalTexture():SetSize(30, 30)

f:SetHighlightTexture('Interface\\AddOns\\KkthnxUI\\Media\\Textures\\picomenuHighlight')
...
--TicketStatusFrameButton:ClearAllPoints()
--TicketStatusFrameButton:SetPoint('TOPLEFT', f, 'BOTTOMRIGHT', -26, 26)
--TicketStatusFrameButton:SetScale(0.6)
--TicketStatusFrameButton:SetParent(f)
