...
if C["blizzard"].bnet_toast ~= true then return end

-- Intercepts the BNToastFrame when Friends / Guild go on and offline. (Code from Bunny67 / Idea from crumdidlyumshis)
-- https://github.com/Bunny67 / https://github.com/crumdidlyumshis
