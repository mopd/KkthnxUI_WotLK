	...
	["DRUID"] = {
		{
			...
			Interval = 3,
			Mode = "ICON",
			setPoint = { "BOTTOMRIGHT", "PlayerFrame", "TOPRIGHT", 2, 173 },
		...
		
		{
			...
			Interval = 3,
			Mode = "ICON",
			setPoint = { "BOTTOMLEFT", "TargetFrame", "TOPLEFT", -2, 173 },
		...
		
		{
			...
			Interval = 3,
			Mode = "ICON",
			setPoint = { "BOTTOMLEFT", "TargetFrame", "TOPLEFT", -2, 213 },
...

		{
			...
			Interval = 3,
			Mode = "BAR",
			setPoint = { "BOTTOMLEFT", "TargetFrame", "BOTTOMRIGHT", 9, -41 },
		...
		
		{
			...
			Interval = 3,
			Mode = "BAR",
			setPoint = { "TOPLEFT", "PlayerFrame", "BOTTOMLEFT", -2, -44 },
...

		{
			...
			Interval = 3,
			Mode = "ICON",
			setPoint = { "BOTTOMRIGHT", "PlayerFrame", "TOPRIGHT", 63, 17 },
	...
	["ALL"] = {
		{
			...
			Interval = 3,
			Mode = "ICON",
			setPoint = { "BOTTOMRIGHT", "PlayerFrame", "TOPRIGHT", 2, 253 },
		...
		},
		{
			...
			Interval = 3,
			Mode = "ICON",
			setPoint = { "BOTTOMLEFT", "TargetFrame", "TOPLEFT", -2, 253 },
