--	Localization for enUS & enGB client
...
L_GUI_AUTOMATION_REPAIRNSELL = "Automatically sell all your grey items & repair your equipement"
...
L_GUI_MISC_FADE_GAMEMENU = "Fade out the background when you hit ESC"
