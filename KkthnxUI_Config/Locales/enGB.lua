...
L_GUI_BAGS_MONEY_COINS = "Use coin icons instead of colored text. |cffffd7001g|r|cffc7c7cf2s|r|cffeda55f3c|r"
...
-- Chat Localization
L_GUI_CHAT_CHATEDITBOX_NOBACKDROP = "Remove the chat editbox backdrop."
...
L_GUI_GENERAL_MONEY_FORMAT = "The display format of the money text."
