if GetLocale() == "ruRU" then
	...
	L_GUI_RESET_ALL = "Are you sure you want to reset all settings for |cFF4488FFKkthnxUI|r"
	L_GUI_RESET_CHAR = "Are you sure you want to reset your character's settings for |cFF4488FFKkthnx's|r|cFFFEB200UI|r?"
	L_GUI_SET_SAVED_SETTTINGS = "Настроек для каждого персонажа"
	L_GUI_BUTTON_RESET = "Общий сброс UI"
	
	L_GUI_MEDIA = "Медия"
	
	L_GUI_ACTIONBAR_ENABLE = "Включить / Выключить панели команд"
	L_GUI_ACTIONBAR_SCALE = "Масштаб MainMenuExpBar"
	L_GUI_ACTIONBAR_SHOW_BARART = "Поазать / Скрыть  MainMenuBar текстуру"
	L_GUI_ACTIONBAR_SHOW_GRID = "Always show all actionbar buttons"
	L_GUI_ACTIONBAR_SHOW_HOTKEYS = "Показать / Скрыть текст клавиш"
	L_GUI_ACTIONBAR_SHOW_MACRONAME = "Показать / Скрыть текст макросов"
