...
L_GUI_ACTIONBAR_SHOW_GRID = "Всегда показывать все кнопки панелей."
...
L_GUI_ANNOUNCEMENTS_PULL_COUNTDOWN = "Анонсировать использование важных кулдаунов."
...
L_GUI_BUFFS_CLASS_COLOR = "Окрасить рамки баффов по цвету класса."
...
L_GUI_GENERAL_REPLACE_BLIZZ_FONTS = "Заменить стандартный шрифт Blizzard на различных панелях и фреймах |cff2eb6ffKkthnxUI|r"
...
L_GUI_MINIMAP_CLASSCOLOR = "Использовать цвет класса для оконтовки миникарты."
...
L_GUI_NAMEPLATE_THREAT = "Включить отображение агро, в зависимости от вашей роли"
...
L_GUI_NAMEPLATE_GOOD_COLOR = "Цвет плохого АГРО"
L_GUI_NAMEPLATE_NEAR_COLOR = "Цвет уменьшения/увеличения АГРО"
L_GUI_NAMEPLATE_BAD_COLOR = "Цвет хорошего АГРО"
...
L_GUI_SKINS_CHAT_BUBBLE = "Стилизовать облачки сообщений."
