...
L_GUI_ACTIONBAR_REMOVE_TEXTRES = "Скрыть текстуру главной панели."
...
L_GUI_ANNOUNCEMENTS_SPELLS = "Анонсировать в группу/рейд применение ваших некоторых умений."
...
--L_GUI_CHAT_DAMAGE_METER_SPAM = "Не понял, что это за функция."
...
L_GUI_GENERAL_REPLACE_BLIZZ_FONTS = "Заменить шрифт Blizzard на различных панелях и фреймах |cff2eb6ffKkthnxUI|r."
...
--L_GUI_MINIMAP_PING = "Не понял что это за функция"
-- Misc Localization
L_GUI_MISC = "Разное"
...
--L_GUI_TOOLTIP_INSTANCE_LOCK = "Не понял, что это за функция."
