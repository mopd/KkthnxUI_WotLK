...
L_GUI_CHAT_GOLD = "Removing some spam in channels like Global, Trade, LFG"
L_GUI_CHAT_SPAM = "Removing some system spam in channels like ('Player1' won duel 'Player2')"
